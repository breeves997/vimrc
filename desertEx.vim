...
highlight csClass guifg=skyblue gui=bold ctermfg=215 cterm=bold
highlight csIface guifg=tan1 gui=bold ctermfg=215 cterm=bold
"highlight CSharpUserType guifg=aquamarine2 gui=bold ctermfg=215 cterm=bold
